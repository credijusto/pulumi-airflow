...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-airflow
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-airflow/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-airflow/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-airflow_darwin_amd64_v1
│   └── pulumi-resource-airflow
├── pulumi-airflow_darwin_arm64
│   └── pulumi-resource-airflow
├── pulumi-airflow_linux_amd64_v1
│   └── pulumi-resource-airflow
├── pulumi-airflow_linux_arm64
│   └── pulumi-resource-airflow
├── pulumi-airflow_windows_amd64_v1
│   └── pulumi-resource-airflow.exe
└── pulumi-airflow_windows_arm64
    └── pulumi-resource-airflow.exe
```
