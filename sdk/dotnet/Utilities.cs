...
namespace Pulumi.Airflow
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Airflow.version.txt");
    ...
    internal sealed class AirflowResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AirflowResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
